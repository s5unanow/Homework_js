...
1. Get data: input and object names
2. Change data
  2.1 Split into array by "/t"
  2.2 Copy data to appropriate objects
3. Output data


structure of output:
<h2 class="char-name">Character</h2>
<p><span id="key">Key</span>Value</p> //p.innerHTML(
 */

const characters = [ "Городничий",
  "Аммос Федорович",
  "Артемий Филиппович",
  "Лука Лукич"];


let allLines = `ДЕЙСТВИЕ ПЕРВОЕ
